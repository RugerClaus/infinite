...
player_2_surface = pygame.image.load('graphics/Player/player_walk_2.png').convert_alpha()
...
player_2_rect = player_2_surface.get_rect(topleft = (player_x,player_y))
passed_snail = False

paused_surface = pygame.Surface((800,400))
